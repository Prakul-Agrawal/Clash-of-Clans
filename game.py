...
from characters import spawnBarbarian, move_barbarians, spawnArcher, spawnStealthArcher, move_archers,\
      spawnDragon, move_dragons, spawnBalloon, move_balloons, spawnHealer, move_healers, clearTroops
